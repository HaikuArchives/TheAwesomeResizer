...
//-------------------------------------------------------------------
AboutBox::AboutBox()
	: BWindow(BRect(140, 40, 350, 175), "About TAResizer...", B_TITLED_WINDOW_LOOK,
	B_MODAL_APP_WINDOW_FEEL, B_NOT_ZOOMABLE | B_NOT_CLOSABLE |
	B_NOT_RESIZABLE | B_NOT_MINIMIZABLE)
{
	Info1 = new BStringView(BRect(10,10,340,20), "", "The Awesome Resizer v3.2 for R5");
	AddChild(Info1);
	Info2 = new BStringView(BRect(10,25,340,35), "", "Copyright ©1999-2000");
	AddChild(Info2);
	...
	AddChild(Info5);
	Web = new BButton(BRect(10, 80, 200, 80), "", "TAResizer Web Page", new BMessage(WEB));
	AddChild(Web);
